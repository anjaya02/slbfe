...
-- ------------------------------------------------------------
-- LOOKUP SEED DATA
-- `migrant_care` export. IDs are the production numeric codes and names
-- trilingual Sinhala | Tamil | English text
-- ------------------------------------------------------------
INSERT INTO `complain_catagory` (`category_id`, `category_name`) VALUES
  ('400', 'රැකියා කොන්ත්‍රාත්තුව උල්ලංගණය කිරීම්  | வேலை ஒப்பந்தத்தை மீறுதல்| Breach of Employment Contract'),
  ('450', 'හිරිහැර සිදුවීම් |துன்புறுத்தல் | Harassment'),
  ('500', 'සන්නිවේදනයේ  අපහසුතා | தொடர்பு இல்லாமை | Lack of Communication'),
  ('550', 'අසනීප වීම්  | நோய்வாய்ப்பட்டது | Sick'),
  ('600', 'සිරගත කිරීම  | சிறையில் அடைக்கப்படுகிறார் | Being Jailed'),
  ('650', 'පොලිසිය විසින් බන්ධනාගාර ගත කිරීම  |  பொலிசாரால் கைது (ரிமான்ட்) செய்யப்படுதல் |  Being  Remanded by Police '),
  ('700', 'රැකියාවක් නොමැතිව අතරමං වීම | வேலை இன்றி சிக்கித் தவித்தல் | Being stranded without employment'),
  ('750', 'ශ්‍රී ලංකාවේ  නිවසේ  ගැටළු |தொழிலாளியின் வீட்டில் பிரச்சினை (இலங்கையில்) | Problems at Employee''s Home (Sri Lanka) '),
  ('800', 'මරණය|மரணம் | Death '),
  ('850', 'නාඳුනන පුද්ගලයෙකු විසින් රඳවා තබා ගැනීම | தெரியாத ஒருவரால் பிடித்து வைக்கப்படுதல் | Being retained by an unknown person'),
  ('900', 'වෙනත් |  மற்றவைகள்| Other');

INSERT INTO `resolution_catagory` (`category_id`, `category_name`) VALUES
  ('10', 'වැටුප් සමඟ නැවත මෙරටට ගෙන්වා ගැනීම|  சம்பளத்துடன் மீண்டும் நாட்டிற்கு அழைத்து வருதல்| Repatriation with salaries.'),
  ('11', 'වහාම ශ්‍රී ලංකාවට ආපසු ගෙන්වා ගැනීම | உடனடியாக இலங்கைக்கு மீள அழைத்து வருதல்| Immediate repatriation to Sri Lanka'),
  ('12', 'ශ්‍රී ලංකාවට නැවත  ගෙන්වා ගැනීම |இலங்கைக்கு மீண்டும் அழைத்து வருதல்| Repatriation to Sri Lanka'),
  ('20', 'සේවකයා පිළිබඳ තොරතුරු ලබා ගැනීම | ஊழியர் பற்றிய தகவல்களைப் பெற்றுக்கொள்ளுதல். |Obtaining information about the employee'),
  ('21', 'සේවකයාගේ  වර්තමාන තත්ත්වය පිළිබඳ තොරතුරු ලබා ගැනීම | ஊழியரின் தற்போதைய நிலை குறித்த தகவல்களைப் பெற்றுக்கொள்ளுதல் | Obtaining information on current situation about the'),
  ('22', 'බන්ධනාගාරයේ නම, චෝදනාව, බන්ධනාගාරයෙන් නිදහස් වූ දිනය ආදිය පිළිබඳ තොරතුරු ලබා ගැනීම | சிறைச்சாலையின் பெயர், குற்றச்சாட்டு, சிறையிலிருந்து விடுதலையான திகதி போன்ற தகவல்களைப் பெற்றுக்கொள்ளுதல் |Obtaining information about the name of the jail, charge alleged for, date of release from the jail etc.'),
  ('23', 'අභියාචනයක් ගොනු කිරීමට ඇති අවස්ථාව සහ ගත හැකි වෙනත් පියවර පිළිබඳ තොරතුරු ලබා ගැනීම | மேன்முறையீடு செய்வதற்கான வாய்ப்பு மற்றும் எடுக்கக்கூடிய ஏனைய நடவடிக்கைகள் குறித்த தகவல்களைப் பெற்றுக்கொள்ளுதல் | Obtaining information about the opportunity to filing an appeal and any other steps that could be taken.'),
  ('24', 'සේවකයා නිදහස් කර ගැනීමට කටයුතු සම්පාදනය කිරීම | ஊழியரை விடுதலை செய்வதற்குத் தேவையான ஏற்பாடுகளைச் செய்தல். | Making arrangements to getting the employee released'),
  ('30', 'සේවකයා මුහුණ දෙන ගැටළු සඳහා ක්ෂණික විසඳුම් |  ஊழியர் எதிர்கொள்ளும் பிரச்சினைகளுக்கு உடனடித் தீர்வுகள் | Immediate solutions for the problems faced by the employee'),
  ('40', 'රැකියා ස්ථානය වහාම වෙනස් කිරීම | வேலைத்தலத்தை உடனடியாக மாற்றுதல் | Changing the place of emloyment immediately '),
  ('41', 'හිග වැටුප් සමඟ රැකියා ස්ථානය වෙනස් කිරීම | நிலுவைச் சம்பளத்துடன் வேலைத்தலத்தை மாற்றுதல் | Changing the place of emloyment with backwages'),
  ('50', 'එකඟ වූ වැටුප් හා පහසුකම් ලබා ගැනීම | ஒப்புக்கொள்ளப்பட்ட சம்பளம் மற்றும் வசதிகளைப் பெற்றுக்கொள்ளுதல் | Obtaining the agreed wages and facilities'),
  ('51', 'පාරිතෝෂික ප්‍රතිලාභ ලබා ගැනීම | மேலதிக்  கொடுப்பணவுகள்  போன்ற நன்மைகளைப் பெற்றுக்கொள்ளுதல். | Obtaining the gratuity benefits'),
  ('52', 'හිග වැටුප් ලබා ගැනීම | நிலுவைச் சம்பளத்தைப் பெற்றுக்கொள்ளுதல். | Obtaining backwages'),
  ('53', 'වන්දි ලබා ගැනීම | இழப்பீட்டைப் பெற்றுக்கொள்ளுதல் | Obtaining compensation'),
  ('60', 'සන්නිවේදනය සඳහා පහසුකම් සැලසීම | தொடர்பாடல் வசதிகளை ஏற்படுத்திக்கொடுத்தல். | Faclilitating communication.'),
  ('61', 'සේවකයාගේ සම්බන්ධතා තොරතුරු ලබා ගැනීම | ஊழியரின் தொடர்பு விபரங்களைப் பெற்றுக்கொள்ளுதல் | Obtaining contact details of the employee'),
  ('99', 'වෙනත් | வேறு | Other');
...
-- ------------------------------------------------------------
-- COMPLAINT SEED DATA
-- These seed rows keep the selected category text in complain_catagory.
-- The lookup table still has numeric IDs, but complaint rows should match
-- what the app reads from complain_details.
-- ------------------------------------------------------------
INSERT INTO `complain_details` (
  ...
  '2026-04-16 06:50:00',
  'Being retained by an unknown person',
  '60',
  'In Progress',
  'CONSULAR',
  '2026-04-19 09:40:00',
  ...
  '2026-05-05 09:15:00',
  'Problems at Employee''s Home (Sri Lanka)',
  '99',
  'Awaiting Info',
  'CONSULAR',
  '2026-05-05 14:20:00',
